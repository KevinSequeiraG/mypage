        ...
        <>
            ...
            <div className='bg-gradient-to-br to-[#3950C3] from-[#9CECFB] dark:bg-gradient-to-br dark:to-[#3950C3] dark:from-black text-white min-h-screen pt-10 pb-32 relative'>
                ...
                <div className="mdx1200:flex">
                    <StudyCard animation={'zoom-in'} image={'../Images/utn.png'} name={"Universidad Técnica Nacional"} startMonth={"jan"} startYear={"2020"} finishMonth={"nov"} finishYear={"2023"} careerName={'software-engineering'} />
