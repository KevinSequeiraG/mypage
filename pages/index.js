...
export default function Home() {
  ...
  return (
    <div className='MainBg text-white max-w-[100vh]'>
      <Head>
      ...
      <nav className='text-right pr-6 pt-5 absolute right-0 z-50'>
        ...
        <div className={`animate__animated ${showSettings ? 'animate__fadeInTopRight' : 'animate__fadeOutTopRight'} border-2 rounded-xl w-[10rem] px-3 py-4 bg-black bg-opacity-80`}>
          {/* Theme config */}
