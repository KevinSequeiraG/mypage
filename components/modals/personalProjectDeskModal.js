...
const PersonalProjectDeskModal = () => {
    ...
    return (
        <>{showModal ? <div className={`min-h-screen max-w-[100vh] mdx1200:max-w-[100%] w-full bg-opacity-70 bg-black absolute top-0 z-[100]`}>
            ...
            <div className="text-center animate__animated animate__flipInX bg-gray-300 dark:bg-gray-800 w-[90%] mdx1200:w-3/6 px-6 py-4 rounded-[1rem] top-[5%] left-[50%] mdx1200:top-1/4 mdx1200:left-1/4 -translate-x-1/2 absolute opacity-100 max-h-[85vh] overflow-auto dark:text-gray-300">
