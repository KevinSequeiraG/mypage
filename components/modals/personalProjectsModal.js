...
const PersonalProjectsModal = () => {
    ...
    return (
        <div className="border-2 border-gray-400 dark:border-gray-500 xl:w-[45%] w-[90%] xl:mx-0 mx-auto px-4 xl:px-7 py-5 rounded-lg justify-content BoxShadow text-white font-semibold">
            <h2 className="text-[1.4rem] xl:text-[2rem] mb-4">{t["projects-made-by-own-learning"]}</h2>
            <p className="text-[.8rem] xl:text-[1rem] text-justify">{t["personal-projects-explication"]}</p>
