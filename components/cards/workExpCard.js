...
const WorkExpCard = (props) => {
    ...
    return (
        <>
            <div data-aos={props.animation} className="mdx1200:mt-32 relative mdx1200:mx-8 w-[85%] mx-auto border-2 border-white dark:border-[#B8B8B8] rounded-xl my-8 py-5 px-3 text-center text-white font-semibold">
