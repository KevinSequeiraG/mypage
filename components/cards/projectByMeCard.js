...
const ProjectByMeCard = (props) => {
    ...
    return (
        <>
            <div data-aos={props.animation} className="shadow-lg shadow-white mdx1400:mt-32 mdx1400:mx-8 w-[85%] mdx1400:w-[20%] mx-auto border-2 border-white dark:border-[#B8B8B8] max-h-[20rem] rounded-xl my-8 py-5 px-3 text-center text-white font-semibold">
                <div className="h-[50%]">
                ...
                <div className="h-[50%] flex items-center justify-center content-center flex-col mt-4">
                    ...
                    <div className="flex">
                        <button onClick={() => { Router.push(props.link) }} className="mx-2 truncate text-[.8rem] mdx1400:text-[1rem] bg-gray-500 dark:bg-black text-white px-3 py-1 rounded-xl border border-2 mt-6 font-bold">{t["go-to-page"]}</button>
