...
const ProjectByMeCardDesk = (props) => {
    ...
    return (
        <>
            <div data-aos={props.animation} className="shadow-lg shadow-white mdx1200:mt-32 mdx1200:mx-8 w-[85%] mdx1200:w-[20%] mx-auto border-2 border-white dark:border-[#B8B8B8] max-h-[20rem] rounded-xl my-8 py-5 px-3 text-center text-white font-semibold">
                <div className="h-[50%]">
