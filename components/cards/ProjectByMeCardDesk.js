...
const ProjectByMeCardDesk = (props) => {
    ...
    return (
        <>
            <div data-aos={props.animation} className="shadow-lg shadow-white mdx1200:mt-16 mdx1400:mt-32 mdx1200:mx-4 mdx1400:mx-8 w-[85%] mdx1200:w-[45%] mdx1400:w-[28%] mx-auto border-2 border-white dark:border-[#B8B8B8] h-[25rem] rounded-xl my-8 py-5 px-3 text-center text-white font-semibold overflow-hidden">
                <div className="h-[50%]">
                ...
                <div className="h-[50%] flex items-center justify-center content-center flex-col mt-4">
                    ...
                    <div className="flex">
                        ...
                        <button onClick={() => { window.open(props.repolink, '_blank', 'noopener,noreferrer') }} className="mx-2 truncate text-[.8rem] mdx1200:text-[1rem] bg-gray-500 dark:bg-black text-white px-3 py-1 rounded-xl border border-2 mt-6 font-bold">{t["go-to-repo"]}</button>
                    </div>
                </div>
            </div>
        </>
